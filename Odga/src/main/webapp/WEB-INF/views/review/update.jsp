						...
						<div class="col-lg-10 col-md-8" align="center">
							...
							<form action="update.do" method="post" enctype="multipart/form-data">
								...
								<div class="mt-10 mb-20" style="width: 782px;">
									<label for="mainfile" class="genric-btn default" style="width:21%;">메인이미지 선택</label><input id="mainfile" name="file" type="file" class="genric-btn default" style="width:78%;text-align:left;" accept=".jpg,.jpeg,.png" required/><br> <!-- Choose File -->
								</div>	
