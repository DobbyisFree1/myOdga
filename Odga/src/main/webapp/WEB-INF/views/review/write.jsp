                        ...
                        <div class="input-group-icon mt-10 mb-20" style="width:782px;" >
                           <div class="form-select" id="default-select" >
                              <select name="b_catgo" style="display: none;padding-left: 21px;" >
                                 <option value="">여행 테마를 골라주세요</option>
...
document.getElementById('submitBtn').onclick = function(){   
   var rf = document.reviewFrm;
   $(".btn").on("click", function() {
      var ir1 = document.getElementById("ir1").value;
   });         
   if(rf.b_subject.value == ""){
      swal({
         text: "글 제목을 입력해주세요.",
         buttons:{"확인":true},
      }).then((value) => {
   ...
   }else if(rf.b_content.value == "" || rf.b_content.value == "<br>" || rf.b_content.value == "<p>&bnsp;</p>" || rf.b_content.value == "사진과 글을 원하는 위치에 이쁘게 꾸며주세요!<br>사진은 우측 상단 버튼을 이용해서 넣어주세요!"){
      swal({
         text: "글 내용을 입력해주세요.",
         buttons:{"확인":true}
      }).then((value) => {
...
<!-- JS here -->   
      ...
      <script type="text/javascript">
         ...
         function validation(){ 
            ...
            if(contents === '<p>&bnsp;</p>' || contents === '' || contents === '<br>' || contents === '사진과 글을 원하는 위치에 이쁘게 꾸며주세요!<br/>사진은 우측 상단 버튼을 이용해서 넣어주세요!'){ // 기본적으로 아무것도 입력하지 않아도 값이 입력되어 있음. 
               alert("내용을 입력하세요."); 
